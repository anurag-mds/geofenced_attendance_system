...
public class LeaveServiceImpl implements LeaveService {
    ...
    @Override
    public List<Leave> getLeaveRequestsForDepartment(int departmentId,
            LeaveStatus statusFilter, String employeeSearch,
            Integer leaveTypeIdFilter, LocalDate fromDate, LocalDate toDate) {
        return leaveDao.findAllByDepartment(departmentId, statusFilter,
    ...
    @Override
    public Leave getLeaveByIdForDepartment(int leaveId, int departmentId) {
        return leaveDao.findByIdAndDepartment(leaveId, departmentId);
    }
    ...
    private void transitionHrStatus(int leaveId, int hrEmpId, String remark,
        ...
        Leave leave = leaveDao.findByIdAndHrDepartment(leaveId, hrEmpId);
        if (leave == null) {
            throw new LeaveServiceException("Leave request not found.");
        }
        ...
        if (notificationMessage != null) {
            leaveDao.insertNotification(leave.getEmpId(), leave.getLeaveId(), notificationMessage);
        }
    }
