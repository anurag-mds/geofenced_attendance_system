//This servlet allows authorized HR users to approve a leave request.
//Only HR can reach this endpoint, and LeaveService validates that the request
//is in an actionable state before the status changes to APPROVED.
...
public class ApproveLeaveServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            leaveService.approveLeave(leaveId, hr.getEmpId(), remark);
    ...
    private void redirectWithSuccess(HttpServletResponse response,
        ...
        response.sendRedirect(request.getContextPath()
                + "/HrLeaveRequestsServlet?id=" + leaveId + "&success=approved");
    }
